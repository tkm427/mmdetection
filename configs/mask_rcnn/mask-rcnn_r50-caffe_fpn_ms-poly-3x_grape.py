...
backend_args = None
data_root = './data/fastgrape/grape/fuji'
...
test_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root='./data/fastgrape/grape/fuji',
        metainfo=dict(classes=('grapeBerry', ), palette=[
            (
                220,
                20,
                60,
...
test_evaluator = dict(
    ann_file='./data/fastgrape/grape/fuji/val/annotation_coco.json',
    backend_args=None,
    format_only=False,
    metric=[
        'bbox',
